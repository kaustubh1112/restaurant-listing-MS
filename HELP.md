...
* The original package name 'com.restaurent.order.restaurant-listing-MS' is invalid and this project uses 'com.restaurent.order.restaurant_listing_MS' instead.
